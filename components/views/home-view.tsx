...
export function HomeView({ onBet, onMarketClick, activeCategory, setActiveCategory }: HomeViewProps) {
  const featuredMarket = MARKETS_DATA.find((m) => m.id === "squeezie-gp-explorer") as BinaryMarket
  ...
  const filteredMarkets =
    activeCategory === "trending"
      ? MARKETS_DATA.filter((m) => m.isLive || m.id === "squeezie-gp-explorer")
      : activeCategory === "all"
        ? MARKETS_DATA
        : MARKETS_DATA.filter((m) => m.category.toLowerCase() === activeCategory)
